...
| Документ | Описание |
|----------|----------|
| [APITOOL.md](../APITOOL.md) | Главная документация — архитектура, MCP tools, CLI, YAML формат |
| [BACKLOG-AI-NATIVE.md](BACKLOG-AI-NATIVE.md) | AI-native стратегия и бэклог: M22 (done) → M23 → M26 → M24 → M25 |
